...
def solve(config:Dict[str,Union[int,Tuple[np.float64,np.ndarray]]],attempts=5) -> Tuple[np.ndarray,np.ndarray]:
    # Unpack data from dictionary
    keyframes: Dict[str,Tuple[np.float64,np.ndarray]] = config["keyframes"]
