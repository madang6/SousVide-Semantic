...
#FIXME OFFBOARD SSV DEMO
    def offboard_state_cb(self, msg: UInt8):
        # HelperState.COMPLETE == 3
        if int(msg.data) == 3:
            # Offboard says "found it"
            self.found = True
            self.offboard_detected = True  # optional latch for debugging
